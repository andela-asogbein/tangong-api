...
module.exports = function (app) {
  gigRouter.route('/gigs/').get(gig.getGigs)
  // .post(auth.verifyToken,gig.addImage,gig.addGig)
  .post(gig.addGig).delete(auth.verifyToken, gig.deleteAll);
  ...
  gigRouter.route('/gig/:gig_id').get(gig.getOneGig).put(auth.verifyToken, gig.addImage, gig.updateGig).delete(auth.verifyToken, gig.deleteGig);
