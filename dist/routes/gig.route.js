...
module.exports = function (app) {
  gigRouter.route('/gigs/').get(gig.getGigs).post(user.verifyToken, gig.addImage, gig.addGig).delete(user.verifyToken, gig.deleteAll);
  ...
  gigRouter.route('/gig/:gig_id').get(gig.getOneGig).put(user.verifyToken, gig.addImage, gig.updateGig).delete(user.verifyToken, gig.deleteGig);
