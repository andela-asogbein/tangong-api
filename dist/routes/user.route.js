...
module.exports = function (app) {
  ...
  userRouter.route('/users').get(user.getUsers).post(user.addUser).delete(user.verifyToken, user.deleteAllUsers);

  userRouter.route('/user/:user_id').get(user.getOneUser).put(user.verifyToken, user.updateUser).delete(user.verifyToken, user.deleteUser);
